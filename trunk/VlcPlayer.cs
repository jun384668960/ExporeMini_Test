...
namespace vlc.net
{
    class VlcPlayer
    {
        ...
        public void Play(string url, int delay)
        {
            string _delay = ":network-caching=" + delay;
            IntPtr libvlc_media = LibVlcAPI.libvlc_media_new_location(libvlc_instance_, url);
            LibVlcAPI.libvlc_media_add_option(libvlc_media, _delay);
    ...
    internal static class LibVlcAPI
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern void libvlc_media_add_option(IntPtr libvlc_mediaplayer, string param);
